...
const activityLabels = {
  ...
  chart_arguments_normalized: ["建图参数已规范", "Runtime 已补全或规范化 generate_chart 参数"],
  reflection_checked: ["自检完成", "Reflection 已检查最新工具结果"],
  reflection_retry: ["准备重试", "Reflection 判断错误可恢复，交回模型修正"],
  reflection_stopped: ["自检停止", "Reflection 判断应停止本轮执行"],
